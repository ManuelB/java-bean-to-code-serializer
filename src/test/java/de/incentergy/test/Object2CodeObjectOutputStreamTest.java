...
public class Object2CodeObjectOutputStreamTest {
    ...
    @Test
    public void testWriteObjectWithCustomConstructor() throws SecurityException, IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        try (Object2CodeObjectOutputStream object2CodeObjectOutputStream = new Object2CodeObjectOutputStream(
                byteArrayOutputStream)) {

        	Object2CodeObjectOutputStream.addCustomConstructorGenerator(GregorianCalendar.class, (o) -> {
